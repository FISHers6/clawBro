...
//! `accept_task`, `reopen_task`, `request_help`) live in `clawbro-runtime::tool_bridge`
...
use clawbro_runtime::{RuntimeRole, TeamToolCall};
        ...
        ServerInfo {
            instructions: Some(
                "ACP-family shared team tools. \
                 ...
                 Canonical multi-backend semantics are defined in clawbro-runtime's tool_bridge contract."
                    .to_string(),
            ),
