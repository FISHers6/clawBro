...
impl MemoryDistiller for AcpDistiller {
    async fn distill(&self, logs: &str, current_memory: &str) -> Result<String> {
        use clawbro_runtime::acp::session_driver::{run_command_turn, AcpCommandConfig};
        use clawbro_runtime::{
            ...
            rt.block_on(local.run_until(async move {
                ...
                run_command_turn(
                    ...
                    RuntimeSessionSpec {
                        ...
                        session_key: clawbro_protocol::SessionKey::new("ws", "distiller"),
                    ...
                    clawbro_runtime::RuntimeEventSink::new(tx),
