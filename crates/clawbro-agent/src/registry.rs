...
impl SessionRegistry {
    ...
    async fn handle_with_context_internal(
        ...
        if inbound.source == clawbro_protocol::MsgSource::Human {
        ...
        if inbound.source == clawbro_protocol::MsgSource::Human && routing.is_lead {
        ...
        if inbound.source == clawbro_protocol::MsgSource::TeamNotify {
...
mod tests {
    ...
    use clawbro_protocol::{InboundMsg, MsgContent};
    use clawbro_runtime::contract::{TeamCallback, TurnResult};
    use clawbro_runtime::RuntimeEvent;
    use clawbro_session::SessionStorage;
    ...
    fn test_lead_fallback_uses_front_bot_roster_entry() {
        ...
        let lead_key = clawbro_protocol::SessionKey::new("lark", "group:123");
    ...
    fn test_workspace_agents_skills_dir_included_in_loader() {
        ...
        let loader = clawbro_skills::SkillLoader::with_dirs(dirs);
    ...
    fn test_workspace_skill_dirs_merged_with_gateway_dirs() {
        ...
        let loader = clawbro_skills::SkillLoader::with_dirs(all_dirs);
        let skills = loader.load_all();
    ...
    fn test_no_roster_match_persona_prefix_not_applied() {
        ...
        let loader = clawbro_skills::SkillLoader::with_dirs(vec![tmp.path().to_path_buf()]);
