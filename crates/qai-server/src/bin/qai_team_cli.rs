...
use qai_runtime::{render_team_helper_success, TeamToolCall, TeamToolRequest, TeamToolResponse};
...
mod tests {
    ...
    fn render_submit_task_result_as_structured_json() {
        ...
        assert_eq!(rendered["contract"], qai_runtime::TEAM_HELPER_CONTRACT);
        assert_eq!(rendered["version"], qai_runtime::TEAM_HELPER_VERSION);
