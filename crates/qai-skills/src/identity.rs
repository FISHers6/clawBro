// quickai-gateway/crates/qai-skills/src/identity.rs
...
pub struct IdentityData {
    ...
    /// Raw MBTI type string, e.g. "INTJ". Use `qai_skills::MbtiType::from_str()` to parse.
...
///
/// 1. `~/.quickai/agents/{agent_name}/IDENTITY.md` — operator/user override
...
mod tests {
    ...
    fn test_load_with_priority_returns_package_identity() {
        ...
        write_identity(&tmp, "---\nname: Rex\nemoji: 🦅\nmbti: INTJ\n---\n");
        // Use a name highly unlikely to exist in ~/.quickai/agents/
