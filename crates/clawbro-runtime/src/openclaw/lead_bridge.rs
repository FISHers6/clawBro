use crate::contract::{RuntimeEvent, TeamCallback};
use crate::helper_contract::ParsedTeamHelperResult;
use anyhow::anyhow;
...
pub struct OpenClawLeadRunBinding {
    ...
    pub session_key: clawbro_protocol::SessionKey,
    pub team_id: String,
...
fn required_string_field(value: &Value, key: &str) -> anyhow::Result<String> {
    crate::helper_contract::required_string_field(value, key, "lead helper result")
}

fn optional_string_field(value: &Value, key: &str) -> Option<String> {
    crate::helper_contract::optional_string_field(value, key)
}
...
mod tests {
    use super::*;
    use crate::render_team_helper_success;
    ...
    fn lead_helper_failure_becomes_command_failed() {
        let json =
            crate::render_team_helper_failure("assign_task", Some("T001"), "missing assignee");
    ...
    fn binding() -> OpenClawLeadRunBinding {
        OpenClawLeadRunBinding {
            ...
            session_key: clawbro_protocol::SessionKey::new("ws", "group:test"),
            team_id: "group".into(),
