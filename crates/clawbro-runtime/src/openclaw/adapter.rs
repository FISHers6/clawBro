...
mod tests {
    ...
    fn helper_result_is_normalized_into_canonical_tool_callback() {
        let bridge = OpenClawTeamBridge::new(OpenClawRunBinding {
            ...
            task_id: String::new(),
            session_key: clawbro_protocol::SessionKey::new("specialist", "team-test:openclaw-main"),
        ...
        let err = adapter
            .run_turn(
                ...
                RuntimeSessionSpec {
                    ...
                    session_key: clawbro_protocol::SessionKey::new("ws", "openclaw:test"),
    ...
    fn openclaw_prompt_includes_helper_commands_for_specialists() {
        ...
        let session = RuntimeSessionSpec {
            ...
            session_key: clawbro_protocol::SessionKey::new("specialist", "team:codex"),
    ...
    fn openclaw_prompt_includes_helper_commands_for_leaders() {
        ...
        let session = RuntimeSessionSpec {
            ...
            session_key: clawbro_protocol::SessionKey::new("ws", "group:team"),
