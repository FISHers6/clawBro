...
fn required_string_field(value: &Value, key: &str) -> anyhow::Result<String> {
    crate::helper_contract::required_string_field(value, key, "team helper result")
}
...
mod tests {
    ...
    fn binding(task_id: &str) -> OpenClawRunBinding {
        OpenClawRunBinding {
            ...
            session_key: clawbro_protocol::SessionKey::new("specialist", "team:openclaw"),
    ...
    fn helper_failure_becomes_command_failed() {
        let json = crate::render_team_helper_failure(
            "submit_task_result",
            Some("T001"),
            "missing summary",
        );
