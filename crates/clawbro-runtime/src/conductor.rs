...
mod tests {
    ...
    async fn conductor_translates_intent_to_runtime_event_stream() {
        ...
        let result = conductor
            .execute(TurnIntent {
                session_key: clawbro_protocol::SessionKey::new("lark", "group:test"),
                mode: TurnMode::Team,
    ...
    async fn conductor_uses_specialist_role_for_non_leader_team_target() {
        ...
        conductor
            .execute(TurnIntent {
                session_key: clawbro_protocol::SessionKey::new("relay", "group:test:openclaw"),
                mode: TurnMode::Team,
    ...
    async fn conductor_allows_relay_when_backend_is_relay_only() {
        ...
        let result = conductor
            .execute(TurnIntent {
                session_key: clawbro_protocol::SessionKey::new("relay", "group:test:relay"),
                mode: TurnMode::Relay,
