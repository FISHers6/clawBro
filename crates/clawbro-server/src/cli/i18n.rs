...
pub struct Messages {
    ...
    pub select_dingtalk_mode: &'static str,
    pub dingtalk_mode_stream: &'static str,
    pub dingtalk_mode_webhook: &'static str,
    pub enter_dingtalk_webhook_secret_key: &'static str,
    pub enter_dingtalk_webhook_access_token: &'static str,
    pub enter_dingtalk_webhook_path: &'static str,
...
static ZH: Messages = Messages {
    ...
    select_dingtalk_mode: "选择钉钉接入模式",
    dingtalk_mode_stream: "Stream Mode — 开放平台应用收消息",
    dingtalk_mode_webhook: "Webhook Mode — 自定义机器人群聊回调",
    enter_dingtalk_webhook_secret_key: "钉钉自定义机器人 secret_key",
    enter_dingtalk_webhook_access_token: "Webhook fallback access_token（可留空）",
    enter_dingtalk_webhook_path: "Webhook 路径（留空使用 /channels/dingtalk/webhook）",
...
static EN: Messages = Messages {
    ...
    select_dingtalk_mode: "Select DingTalk receive mode",
    dingtalk_mode_stream: "Stream Mode — open-platform app ingress",
    dingtalk_mode_webhook: "Webhook Mode — custom robot group webhook",
    enter_dingtalk_webhook_secret_key: "Custom robot secret_key",
    enter_dingtalk_webhook_access_token: "Webhook fallback access_token (optional)",
    enter_dingtalk_webhook_path: "Webhook path (leave empty for /channels/dingtalk/webhook)",
...
static JA: Messages = Messages {
    ...
    select_dingtalk_mode: "DingTalk 受信モードを選択",
    dingtalk_mode_stream: "Stream Mode — Open Platform アプリ受信",
    dingtalk_mode_webhook: "Webhook Mode — カスタムロボット群Webhook",
    enter_dingtalk_webhook_secret_key: "カスタムロボット secret_key",
    enter_dingtalk_webhook_access_token: "Webhook fallback access_token（任意）",
    enter_dingtalk_webhook_path: "Webhook パス（空欄で /channels/dingtalk/webhook）",
...
static KO: Messages = Messages {
    ...
    select_dingtalk_mode: "DingTalk 수신 모드 선택",
    dingtalk_mode_stream: "Stream Mode — 오픈 플랫폼 앱 수신",
    dingtalk_mode_webhook: "Webhook Mode — 커스텀 로봇 그룹 웹훅",
    enter_dingtalk_webhook_secret_key: "커스텀 로봇 secret_key",
    enter_dingtalk_webhook_access_token: "Webhook fallback access_token（선택사항）",
    enter_dingtalk_webhook_path: "Webhook 경로（비워두면 /channels/dingtalk/webhook）",
