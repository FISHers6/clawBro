use crate::agent_core::approval::ApprovalDecision;
use crate::agent_core::control_reply::ControlReply;
...
mod tests {
    ...
    async fn team_status_with_orchestrator_renders_summary() {
        ...
        registry.register_team_orchestrator(
            crate::agent_core::team::session::stable_team_id_for_session_key(&lead),
            orchestrator,
        );
        let command = SlashCommand::TeamStatus;
        let reply = execute_slash_request(SlashRequest {
