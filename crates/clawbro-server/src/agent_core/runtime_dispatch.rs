...
async fn run_dispatch_job(
    ...
    let runtime_sink = crate::runtime::RuntimeEventSink::new(runtime_tx);
        ...
        .execute_prepared_streaming(
            ...
            RuntimeSessionSpec {
                ...
                tool_surface: ToolSurfaceSpec {
                    team_tools: ctx.team_tool_url.is_some(),
...
fn runtime_role_from_agent_role(role: crate::agent_core::traits::AgentRole) -> RuntimeRole {
    match role {
        crate::agent_core::traits::AgentRole::Solo => RuntimeRole::Solo,
        crate::agent_core::traits::AgentRole::Lead => RuntimeRole::Leader,
        crate::agent_core::traits::AgentRole::Specialist => RuntimeRole::Specialist,
    }
}

fn runtime_context_from_ctx(
    ctx: &AgentCtx,
    family: crate::runtime::backend::BackendFamily,
) -> RuntimeContext {
    ...
    RuntimeContext {
        ...
        history_lines: crate::runtime::render_history_lines(
            &history_messages,
...
fn transcript_semantics_for_family(
    ...
    let pruning = match family {
        crate::runtime::backend::BackendFamily::ClawBroNative => TranscriptPruningMode::Off,
        crate::runtime::backend::BackendFamily::Acp
        | crate::runtime::backend::BackendFamily::OpenClawGateway => {
...
fn default_pruning_policy_for_family(
    ...
    match family {
        crate::runtime::backend::BackendFamily::ClawBroNative => RuntimePruningPolicy::default(),
        crate::runtime::backend::BackendFamily::Acp
        | crate::runtime::backend::BackendFamily::OpenClawGateway => RuntimePruningPolicy {
...
fn scoped_memory_file_stem(session_key: &crate::protocol::SessionKey) -> String {
...
mod tests {
        ...
        let result = dispatcher
            .dispatch(RuntimeDispatchRequest {
                intent: TurnIntent {
                    ...
                    mode: crate::runtime::contract::TurnMode::Solo,
    ...
    async fn runtime_context_includes_external_mcp_servers() {
        ...
        runtime_registry
            .register_backend(BackendSpec {
                ...
                adapter_key: "acp".into(),
                launch: LaunchSpec::BundledCommand,
                external_mcp_servers: vec![crate::runtime::ExternalMcpServerSpec {
                    name: "filesystem".into(),
                    transport: crate::runtime::ExternalMcpTransport::Sse {
    ...
    fn collect_workspace_native_files_includes_heartbeat_when_present() {
        ...
        ctx.session_key = crate::protocol::SessionKey::new("lark", "group:test");
    ...
    fn collect_workspace_native_files_hides_long_term_memory_for_specialists() {
        ...
        let mut ctx = AgentCtx::default();
        ctx.session_key = crate::protocol::SessionKey::new("specialist", "team-1:coder");
        ctx.agent_role = crate::agent_core::traits::AgentRole::Specialist;
        ctx.persona_dir = Some(persona.path().to_path_buf());
        ctx.team_dir = Some(team.path().to_path_buf());
    ...
    fn runtime_context_projection_preserves_structured_history() {
        ...
        ctx.history = vec![
            crate::agent_core::traits::HistoryMsg {
                role: "user".into(),
                content: "hello".into(),
            ...
            crate::agent_core::traits::HistoryMsg {
                ...
                tool_calls: Some(vec![crate::session::ToolCallRecord {
        ...
        let projected = runtime_context_from_ctx(&ctx, crate::runtime::BackendFamily::Acp);
    ...
    fn native_family_defaults_to_no_request_local_pruning() {
        ...
        let mut ctx = AgentCtx::default();
        ctx.history = vec![crate::agent_core::traits::HistoryMsg {
            role: "assistant".into(),
            content: "older".into(),
            sender: None,
            tool_calls: Some(vec![crate::session::ToolCallRecord {
        ...
        let projected =
            runtime_context_from_ctx(&ctx, crate::runtime::BackendFamily::ClawBroNative);
        assert_eq!(
            projected.transcript_semantics.pruning,
    ...
    fn compatibility_families_default_to_request_local_pruning_policy() {
        let acp = transcript_semantics_for_family(crate::runtime::BackendFamily::Acp);
        let openclaw =
            transcript_semantics_for_family(crate::runtime::BackendFamily::OpenClawGateway);
