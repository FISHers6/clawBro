use crate::runtime::contract::RuntimeEvent;
    ...
    async fn send_connect(
        ...
        self.send_frame(GatewayFrame::Request {
            ...
            params: Some(json!({
                ...
                "client": {
                    "id": "gateway-client",
                    "displayName": "clawbro-runtime",
                    "version": env!("CARGO_PKG_VERSION"),
                    "platform": std::env::consts::OS,
                    "mode": "backend",
                    "instanceId": format!("clawbro-{}", uuid::Uuid::new_v4()),
                },
                "role": config.role,
                "scopes": scopes,
                "caps": [],
                ...
                "permissions": {},
                "locale": "en-US",
                "userAgent": format!("clawbro-runtime/{}", env!("CARGO_PKG_VERSION")),
...
pub fn canonical_openclaw_session_key(session_key: &crate::protocol::SessionKey) -> String {
...
mod tests {
    ...
    fn canonical_session_key_is_stable() {
        let key = crate::protocol::SessionKey::new("lark", "group:abc");
